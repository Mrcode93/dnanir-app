...
export const TermsScreen = ({ navigation }: any) => {
  ...
  const sections = [
    ...
    {
      title: tl("9. اتصل بنا"),
      content: tl("إذا كان لديك أي استفسارات أو ملاحظات حول هذه الشروط والأحكام، يرجى التواصل معنا عبر واتساب +9647838584311 أو البريد الإلكتروني ameralazawi69@gmail.com")
    }
  ];
