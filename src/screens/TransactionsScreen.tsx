  ...
  return (
    <TopTab.Navigator
      ...
      screenOptions={{
        ...
        tabBarLabelStyle: { fontFamily: theme.typography.fontFamily, fontWeight: '700', fontSize: 14 },
      }}
    >
      <TopTab.Screen name="Expenses" component={ExpensesScreen} options={{ title: 'المصاريف' }} />
      <TopTab.Screen name="Income" component={IncomeScreen} options={{ title: 'الدخل' }} />
    </TopTab.Navigator>
  );
};
